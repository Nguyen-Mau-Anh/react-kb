...
- [ ] `05.routing-and-styling/01-routing-react-router.md` — `react-router-dom@6.22` data routers, loaders, actions
...
- [ ] `07.nextjs/01-fundamentals.md` — Next.js 14 App Router, file conventions, Server Components
